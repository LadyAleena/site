#!/usr/bin/perl
# This is the index for Miscellany - Political opinions.
use strict;
...
my $pages_dir = file_directory('Miscellany/Political_opinions', 'text');
my @pages     = file_list($pages_dir, { 'type' => 'f', 'uppercase' => 1, 'sort' => 'article', 'text' => 1 });
my $heading   = q(Lady Aleena's political opinions);
