#!/usr/bin/perl
# This is the index for Fandom - Crossovers - Big fake companies.
use strict;
...
my $pages_dir = file_directory('Fandom/Crossovers/Big_fake_companies', 'text');
my @pages     = file_list($pages_dir, { 'type' => 'f', 'uppercase' => 1, 'sort' => 'article', 'text' => 1 });
my $heading   = q(Big fake companies);
